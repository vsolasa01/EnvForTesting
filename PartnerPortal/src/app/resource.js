...
(function () {
     ...
     */
       ...
       .factory('PricingConversion_v1', ['$resource', 'apiUrl', api('/wsconversion_v1')])
       
       .factory('PricingConversion_v2', ['$resource', 'apiUrl', api('/wsconversion_v2')])
       ...
       .factory('ProposalSign', ['$resource', 'apiUrl', api('/proposal/docusign')])
       ...
       .factory('DocusignStatus', ['$resource', 'apiUrl', api('/docusign/status/:envelope')])
